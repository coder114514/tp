...
public class CommandTestUtil {
    ...
    public static final String PRODUCTS_DESC_AMY = " " + PREFIX_PRODUCTS + VALID_PRODUCTS_AMY;
    public static final String PRODUCTS_DESC_BOB = " " + PREFIX_PRODUCTS + VALID_PRODUCTS_BOB;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withProducts(VALID_PRODUCTS_AMY).withLocation(VALID_LOCATION_AMY)
                .withDeadline(VALID_DEADLINE_AMY).withContact(VALID_CONTACT_AMY).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withProducts(VALID_PRODUCTS_BOB).withLocation(VALID_LOCATION_BOB)
                .withDeadline(VALID_DEADLINE_BOB).withContact(VALID_CONTACT_BOB).build();
    }
